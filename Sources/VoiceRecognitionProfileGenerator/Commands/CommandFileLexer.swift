...
struct Token {
    ...
    let keystrokes: Array<Substring>
...
enum CommandFileLexer {
    ...
    static func lex(line: String, lineNumber: Int?) throws -> Token? {
        ...
        let phrases = phrasesMatch.matches(of: phrase).map { phrasesMatch[$0.range].trimmingCharacters(in: .whitespaces) }
            .compactMap { $0.isEmpty ? nil : $0 }
        
        var aliasDefinition: Substring? = nil,
            aliasReference: Substring? = nil
